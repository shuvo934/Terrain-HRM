...
public class SecondFragment extends Fragment {
    ...
    TextView calcJoin;
    TextView appoinType;
    TextView revisoinType;
    TextView serviceStatus;
    TextView description;
    TextView probaPeriod;
    TextView probaComp;
    TextView workPeEdDate;
    TextView workPePeriod;
    TextView workPeComp;
    TextView quitDate;
    TextView shiftAlloc;
    TextView salaryPac;
    ...
    TextView conveyaAllow;
    TextView habitation;
    TextView utilty;
    TextView houseAllow;
    TextView entertain;
    TextView factoryAllow;
    TextView committedSalary;
    TextView mobileBill;
    TextView additinAllow;
    TextView fixedOt;
    TextView foodSubsidy;
    TextView otherAlloDetl;
    TextView overtimeAllowApp;
    TextView overtimeRate;
    TextView providentFundType;
    TextView providentFund;
    TextView otCalPeriod;
    TextView taxDeduc;
    TextView sitting;
    TextView lunchStatus;
    TextView transport;
    TextView pabx_office;
    TextView pabx_factory;

//    Spinner fesTypeBonus;
//    Spinner foodSubsidyType;
//    Spinner taxBearer;
    TextView fesTypeBonus;
    TextView foodSubsidyType;
    TextView taxBearer;
